import 'package:fluffychat/utils/metal_utils.dart';
import 'package:fluffychat/widgets/metal_member_builder.dart';
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<Object>(
          ...
          builder: (context, snapshot) {
            return MetalMemberBuilder(
              userId: userId,
              builder: (context, metalMember) {
                return ListView(
                  children: [
                    ...
                    ...MetalUtils.getMemberInfoAsListofTiles(context, metalMember),
                    PresenceBuilder(
                      userId: userId,
                      client: client,
                      builder: (context, presence) {
